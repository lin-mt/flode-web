...
const filterTree = (
  ...
  return data.reduce((acc: TreeDataNode[], item) => {
    ...
    if (included) {
      ...
      if (item.children) {
        newItem.children = filterTree(
          newItem.children as TreeDataNode[],
          targetKeys
        );
      }
      acc.push(newItem);
              ...
              <Tree
                ...
                onCheck={(keys, { checked }) => {
                  ...
                  if (checked) {
                    ...
                    onItemSelectAll(
                      checkedKeys.filter(
                        (item) => !selectedKeys.includes(item.toString())
                      ),
                      false
                    );
                  }
              ...
              <Tree
                ...
                onCheck={(keys, { checked }) => {
                  ...
                  if (checked) {
                    ...
                    onItemSelectAll(
                      selectedKeys.filter(
                        (item) => !selectedKeys.includes(item)
                      ),
                      false
                    );
                  }
